...
export default function sitemap():MetadataRoute.Sitemap{
  const pages=[
    {path:"",priority:1,changeFrequency:"monthly" as const,lastModified:"2026-08-16"},
    {path:"/news",priority:.9,changeFrequency:"weekly" as const,lastModified:articles[0].modifiedAt},
    {path:"/knowledge",priority:.8,changeFrequency:"monthly" as const,lastModified:"2026-08-16"},
    {path:"/products/legal-management",priority:.9,changeFrequency:"monthly" as const,lastModified:"2026-08-16"},
    {path:"/solutions/municipalities",priority:.9,changeFrequency:"monthly" as const,lastModified:"2026-08-16"},
    {path:"/contact",priority:.7,changeFrequency:"yearly" as const,lastModified:"2026-08-16"},
